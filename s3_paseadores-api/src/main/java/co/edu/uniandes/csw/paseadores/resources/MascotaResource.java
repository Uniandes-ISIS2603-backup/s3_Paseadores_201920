...
public class MascotaResource 
{
     ...
     */
     @POST
    public MascotaDTO createMascota(MascotaDTO mascota,@PathParam("clienteId") Long clienteId) throws BusinessLogicException 
    {
        MascotaDTO mascotaDTO = new MascotaDTO(mascotaLogic.createMascota(clienteId, mascota.toEntity()));
        return mascotaDTO;
    }
     /**
     ...
     *
     * @param clienteId id del cliente
     * @return JSONArray {@link MascotaDetailDTO} - Los mascotaes encontrados en la
    ...
    @PUT
    @Path("{mascotasId: \\d+}")
    public MascotaDTO updateMascota(@PathParam("clienteId") Long clienteId, @PathParam("mascotasId") Long mascotasId, MascotaDTO mascota) throws BusinessLogicException 
    {
     ...
     */
     @DELETE
    @Path("{mascotasId: \\d+}")
    public void deleteMascota(@PathParam("mascotasId") Long mascotasId, @PathParam("clienteId") Long clienteId) throws BusinessLogicException 
    {
