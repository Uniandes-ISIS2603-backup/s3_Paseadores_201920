...
import co.edu.uniandes.csw.paseadores.resources.PagoResource;
...
public class PagoIT {
    ...
    private final static String COLLECTION = "PagoResourceTests.postman_collection";
    ...
    public static WebArchive createDeployment() {
        return ShrinkWrap.create(WebArchive.class, "s3_paseadores-api-1.0.war")//War del modulo api
                ...
                .addPackage(PagoResource.class.getPackage()) //No importa cual recurso usar, lo importante es agregar el paquet
                .addPackage(PagoDTO.class.getPackage()) //No importa cual dto usar, lo importante es agregar el paquete.
