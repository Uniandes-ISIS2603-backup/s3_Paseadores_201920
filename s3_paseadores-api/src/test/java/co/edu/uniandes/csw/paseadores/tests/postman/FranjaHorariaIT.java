...
public class FranjaHorariaIT
{
    
    private static final String COLLECTION = "FranjaHorariaResourceTest.postman_collection";

    @Deployment(testable = true)
    public static WebArchive createDeployment() {
        return ShrinkWrap.create(WebArchive.class, "s3_paseadores-api.war")//War del modulo api
