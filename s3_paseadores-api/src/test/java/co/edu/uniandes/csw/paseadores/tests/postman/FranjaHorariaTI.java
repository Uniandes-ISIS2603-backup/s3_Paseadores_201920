...
import co.edu.uniandes.csw.paseadores.resources.FranjaHorariaResource;
...
public class FranjaHorariaTI {

    private final static String COLLECTION = "FranjaHorariaResourceTests.postman_collection";

    @Deployment(testable = true)
    public static WebArchive createDeployment() {
        return ShrinkWrap.create(WebArchive.class, "s3_paseadores-api-1.0.war")//War del modulo api
                // Se agrega las dependencias
                .addAsLibraries(Maven.resolver().loadPomFromFile("pom.xml")
                        .importRuntimeDependencies().resolve()
                        .withTransitivity().asFile())
                // Se agregan los compilados de los paquetes de servicios
                .addPackage(FranjaHorariaResource.class.getPackage()) //No importa cual recurso usar, lo importante es agregar el paquet
                .addPackage(FranjaHorariaDTO.class.getPackage()) //No importa cual dto usar, lo importante es agregar el paquete.
