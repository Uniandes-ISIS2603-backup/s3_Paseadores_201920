...
public class ContratoIT {
    ...
    public static WebArchive createDeployment() {
        return ShrinkWrap.create(WebArchive.class, "s3_paseadores-api-1.0.war")//War del modulo api
                ...
                .addPackage(ContratoResource.class.getPackage()) //No importa cual recurso usar, lo importante es agregar el paquet
                .addPackage(ContratoDTO.class.getPackage()) //No importa cual dto usar, lo importante es agregar el paquete.
