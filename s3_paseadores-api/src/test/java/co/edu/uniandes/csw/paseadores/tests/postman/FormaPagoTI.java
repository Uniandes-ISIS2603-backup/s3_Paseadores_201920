...
import co.edu.uniandes.csw.paseadores.resources.FormaPagoResource;
...
public class FormaPagoTI {

    private final static String COLLECTION = "FormaPagoResourceTests.postman_collection";
    ...
    public static WebArchive createDeployment() {
        return ShrinkWrap.create(WebArchive.class, "s3_paseadores-api-1.0.war")//War del modulo api
                ...
                .addPackage(FormaPagoResource.class.getPackage()) //No importa cual recurso usar, lo importante es agregar el paquet
                .addPackage(FormaPagoDTO.class.getPackage()) //No importa cual dto usar, lo importante es agregar el paquete.
