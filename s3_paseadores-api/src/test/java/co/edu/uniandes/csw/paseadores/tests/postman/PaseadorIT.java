...
import co.edu.uniandes.csw.paseadores.resources.PaseadorResource;
...
public class PaseadorIT {

    private final static String COLLECTION = "PaseadorResourceTests.postman_collection";
    ...
    public static WebArchive createDeployment() {
        return ShrinkWrap.create(WebArchive.class, "s3_paseadores-api-1.0.war")//War del modulo api
                ...
                .addPackage(PaseadorResource.class.getPackage()) //No importa cual recurso usar, lo importante es agregar el paquet
