...
import co.edu.uniandes.csw.paseadores.resources.MascotaResource;
...
public class MascotaIT {
    ...
    private final static String COLLECTION = "MascotaResourceTests.postman_collection";
    ...
    public static WebArchive createDeployment() {
        return ShrinkWrap.create(WebArchive.class, "s3_paseadores-api-1.0.war")//War del modulo api
                ...
                .addPackage(MascotaResource.class.getPackage()) //No importa cual recurso usar, lo importante es agregar el paquet
                .addPackage(MascotaDTO.class.getPackage()) //No importa cual dto usar, lo importante es agregar el paquete.
