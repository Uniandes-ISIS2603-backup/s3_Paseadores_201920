...
/**
 * Clase encargada de la lógica de las franjas horarias.
 *
...
public class FranjaHorariaLogic {
    ...
    /**
     * Persistencia de las franjas horarias.
     */
    @Inject
    ...
    /**
     * Retorna todos las franjas que ofrece un paseador.
     *
     * @param paseadorId. Id del paseador.
     * @return Lista de entidades tipo FranjaHoraria.
     */
    public List<FranjaHorariaEntity> getFranjasPaseador(Long paseadorId) {
        PaseadorEntity paseador = paseadorPersistence.find(paseadorId);
