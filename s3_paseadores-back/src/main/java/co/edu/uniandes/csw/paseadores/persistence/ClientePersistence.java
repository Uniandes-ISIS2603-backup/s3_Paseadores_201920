...
public class ClientePersistence {
     ...
     *
     * @return una lista con todos los clientes de la base de datos. "select u
     * from ClienteEntity u" es como un "select * from ClienteEntity;" - "SELECT
     * * FROM table_name" en SQL
     */
